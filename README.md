<div align="center">
  ...
  <h1>Archy</h1>
  <p><strong>Visual Network Architecture & Connection Manager</strong></p>
  <p>A unified workspace for security researchers, penetration testers, and infrastructure managers</p>
</div>
...
- Credentials stored in: `%APPDATA%/archy/` (Windows) or `~/.config/archy/` (Linux/Mac)
